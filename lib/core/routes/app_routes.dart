...
class AppRoutes {
  ...
  static const String xmlSignViewPage = '/xmlSignView';
}

class AppPages {
  static final routes = [
    GetPage(name: AppRoutes.login, page: () => const DesktopLoginPage(),binding: BindingsBuilder(() { Get.put(LoginController()); }),),
    GetPage(name: AppRoutes.home, page: () => const CertificateListPage(),binding: BindingsBuilder(() { Get.put(CertificateListController()); }),),
    ...
    GetPage(name: AppRoutes.xmlSignViewPage, page: () => XmlSignViewPage(),binding: BindingsBuilder(() { Get.put(XmlSignController()); }),),

...
class CustomSnackbar {
  ...
  static void show({
    ...
    switch (normalizedTitle) {
      ...
      case 'oops': bgColor = hexToColor(CustomColors.warningColorBg); icon = const Icon(Icons.error_outline, color: Colors.white); displayTitle = 'oops'.tr; break;
      ...
      case 'info': bgColor = hexToColor(CustomColors.infoColorBg); icon = const Icon(Icons.info_outline, color: Colors.white); displayTitle = 'note'.tr; break;
      case 'network': bgColor = hexToColor(CustomColors.warningColorBg); icon = const Icon(Icons.wifi_off, color: Colors.white); displayTitle = 'networkError'.tr; break;
      default:
...
class CustomSnackbarOverlay  {
  ...
  static void show(BuildContext context, {
    ...
    OverlayEntry? entry; // null se initialize
    entry = OverlayEntry(
      builder: (context) {
